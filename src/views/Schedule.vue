      ...
      <v-row justify="center" align="center">
        <v-col md="10" class="py-0 my-0">
          ...
          <p class="google-font mb-10" style="font-size: 120%">
            Follow code demonstrations by our expert speakers on different cloud technologies. Check out the schedule below and don't forget to mark your calendar so that you don't miss out on any sessions. <br /><br />
          ...
          <v-tabs
            ...
            slider-color="#4285F4"
          >
            <v-tab href="#day1"> January 22 </v-tab>
            <v-tab href="#day2"> January 23 </v-tab>
          </v-tabs>
          <!-- <v-toolbar
            flat
