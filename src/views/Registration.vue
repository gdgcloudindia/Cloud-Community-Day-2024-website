      ...
      <v-row justify="center" align="center">
        <v-col md="7" sm="8" lg="5" cols="12">
          <div style="padding:10px;">
            ...
            <p class="google-font">
              Your Runway to Google Cloud is the annual cloud conclave organised by 11 GDG Cloud communities.
              <br />
            </p>
            <p class="google-font">
              The mega event is set to happen on
              <b>Jan 22nd & 23rd</b> with the
            ...
            <v-row v-if="userForm && userLoginIn">
              ...
              <v-col md="10" class="google-font" cols="10">
                ...
                <v-form ref="form">
                  ...
                  <!-- Google Cloud Certified Option -->
                  <v-radio-group
                    :rules="[(v) => !!v || 'This field is required.']"
                    v-model="response.certified"
                    class="mb-3"
                  >
                    <div class="google-font mb-3" style="font-size:105%;color:black !important">
                      Are you Google Cloud Certified?
                      <span style="color:#ff5252;">*</span>
                      <br />
                      <span
                        style="color:#ff5252;font-size:70%"
                        v-show="response.certified === 0"
                      >This field is required.</span>
                    </div>
                   ...
                   <!-- <p
                    ...
                    v-if="response.certified && response.certified.toLowerCase() === 'yes'"
                  >
                    New Value
                    <span style="color:#ff5252;">*</span>
                  </p> -->
                  ...
                  <div class="google-font mt-5" style="font-size:105%;color:black"
                      v-if="response.certified && response.certified.toLowerCase() === 'yes'"
                     >
                    Please select the certificates that you’ve acquired?
                    <span style="color:#ff5252;">*</span>
                    <br />
                  ...
                  <v-checkbox
                    class="mb-0"
                    :rules="[rules.certificatebtn]"
                    hide-details="false"
                    color="#4285F4"
                    v-if="response.certified && response.certified.toLowerCase() === 'yes'"
                    v-model="response.certificate"
                  ...
                  <v-checkbox
                    ...
                    value="Professional Data Engineer"
                  ></v-checkbox>
                  <v-checkbox
                    class="my-1"
                    hide-details="false"
                  ...
                  <v-checkbox
                    ...
                    v-if="response.certified && response.certified.toLowerCase() === 'yes'"
                    v-model="response.certificate"
                    label="Professional Network Engineer"
                  ...
                  <v-checkbox
                    ...
                    v-if="response.certified && response.certified.toLowerCase() === 'yes'"
                    v-model="response.certificate"
                    label="Professional Collaboration Engineer"
                    value="Professional Collaboration Engineer"
                  ></v-checkbox>
                  <!-- Google Cloud Certified Option -->
                  ...
                  <!-- Following Certificates -->
                   <div class="google-font mt-5" style="font-size:105%;color:black"
                     >
                    Which of the following certificates are you interested in:
                    <span style="color:#ff5252;">*</span>
                    <br />
                    <span style="font-size:80%;color:black">Check all that apply</span>
                  </div>
                  ...
                  <p
                    class="mt-3"
                  >I agree to let Google Cloud Community Days India Organisers use the information collected in this form to be used for my participation in Google Cloud Community Days India 2021 Event".</p>
                  <p>
            ...
            <v-row v-if="userSuccess && userLoginIn">
              ...
              <v-col md="10" class="google-font" cols="10">
                <h3 class="google-font">
                  ...
                  >
                    <b>#GoogleCloudCommunityDaysIndia</b>
                  </a>.
                </h3>
                <p class="google-font">
                  Thank you for registering for
                  <b>#GoogleCloudCommunityDaysIndia</b> - Your Runway to Google Cloud is the annual cloud conclave organised by 11 GDG Cloud communities.
                  <br />You will be receiving the confirmation mail soon from:
                  <span
                    style="color:red"
                  >no-reply@cloudcommunitydays.in</span>
                </p>
                <!-- <v-btn
            ...
            <v-row v-if="userSubmitedAlready && userLoginIn">
              ...
              <v-col md="10" class="google-font" cols="10">
                ...
                <p class="mb-5">
                  ...
                  <br />
                  <span style="color:red">no-reply@clouccommunitydays.in</span>
                </p>
                <!-- <v-btn
                  v-if="maindata.registrationData.twittershare"
                  :href="maindata.registrationData.twittershare"
      ...
      if (this.$refs.form.validate()) {
        ...
        FDK.firestore
          ...
          .set({
            ...
            certified: this.response.certified,
            share: this.response.share,
            knowAbout: this.response.knowAbout,
            certificate: this.response.certificate,
            certificates: this.response.certificates,
