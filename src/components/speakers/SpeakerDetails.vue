<template>
  <v-dialog v-model="dialog" width="800" scrollable>
    <template v-slot:activator="{ on }">
      ...
      >
        <v-avatar size="100">
          <img :src="getImgUrl(data.image)" :lazy-src="getImgUrl(data.image)" alt  class="speaker-image" />
        </v-avatar>
        ...
        <v-chip x-small class="my-2" color="primary" outlined v-if="data.type==='s'">Speaker</v-chip>
        <v-chip x-small class="my-2" color="red" outlined v-else>Panellist</v-chip>
