        ...
        <v-row justify="center" align="center" class="ma-0 pa-0" >
            <v-col md="12" class="ma-0 pa-0">
                <p class="devfest-font my-0 py-0" style="font-size: 2.0vh;line-height: 1.22;font-weight:500"> 
                    <!-- Days -->
                    <span style="color:#4285F4;"><b>{{ days | twoDigits }}</b></span> 
                    {{ days > 1 ? 'Days' : 'Day' }}

                    <!-- Hours -->
                    <span style="color:#4285F4;"><b>{{ hours | twoDigits }}</b></span>
                    {{ hours > 1 ? 'Hours' : 'Hour' }}

                    <!-- Min -->
                    <span style="color:#4285F4;"><b>{{ minutes | twoDigits }}</b></span> 
                    {{ minutes > 1 ? 'Minutes' : 'Minute' }}

                    <!-- Sec -->
                    <span style="color:#4285F4;"><b>{{ seconds | twoDigits }}</b></span>
